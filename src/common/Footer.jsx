...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#693268] via-[black] to-[#4c054b]">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <img src="./techvictus-logo.png" className="mr-5 h-20 sm:h-20 object-contain" alt="logo" />
        ...
        <p className="mt-8 text-xs text-white">© 2022 Techvictus</p>
      </div>
    </footer>
  );
};
